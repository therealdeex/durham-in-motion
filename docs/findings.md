...
Generated 2026-09-21 by `npm run data:findings`.
...
- **to:** 2022: 14.1%
- **change:** +9.2 pp
- **notes:** Full-time + part-time usually-work-at-home as a share of employed persons. 1986 omitted (suppressed part-time-at-home cell). 2022 reflects post-2020 hybrid work.
- **Notes:** Full-time + part-time usually-work-at-home as a share of employed persons. 1986 omitted (suppressed part-time-at-home cell). 2022 reflects post-2020 hybrid work.

## vehicles-per-household
- **Headline:** The average Durham household owned 1.71 vehicles in 1986; today it owns 1.81.
...
- **Headline:** Workers commuting to Toronto: highest Pickering (43.5%), lowest Scugog (11.7%).
- **Metric:** toronto_commute_share (comparability: within-2022)
- **value:** highest Pickering 43.5%
- **durham:** 27.5%
- **difference:** 43.5% vs 11.7%
- **notes:** Usual place of work in Toronto, share of workers with a usual place inside the survey area (2022).
- **Notes:** Usual place of work in Toronto, share of workers with a usual place inside the survey area (2022).
...
- **Headline:** Transit's share of resident weekday trips rose from 4.5% in 1986 to 6.4% in 2016 (comparable pre-2022 cycles only).
- **Metric:** transit_share_1986_2016 (comparability: caution)
- **from:** 1986: 4.5%
- **to:** 2016: 6.4%
...
- **Headline:** Ward-level transit share ranges from 5.1% in Oshawa Ward 2 to 0.5% in Clarington Ward 4.
